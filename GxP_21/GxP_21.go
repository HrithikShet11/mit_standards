...
var GxP_21_11_10_a = &NistComp{
	Framework:     "GxP-21-CFR-Part-11",
	Provider:      "AWS",
	Frameworkdesc: "GxP refers to the regulations and guidelines that are applicable to life sciences organizations that make food and medical products. Medical products that fall under this include medicines, medical devices, and medical software applications. The overall intent of GxP requirements is to ensure that food and medical products are safe for consumers. It's also to ensure the integrity of data that's used to make product-related safety decisions.",
	Id:            "11.10-a",
	Name:          "11.10(a)",
...
var GxP_21_11_300_b = &NistComp{
	...
	Checks:        []string{"iam_password_policy_minimum_length_14", "iam_password_policy_lowercase", "iam_password_policy_number", "iam_password_policy_number", "iam_password_policy_symbol", "iam_password_policy_uppercase", "iam_rotate_access_key_90_days", "iam_user_accesskey_unused", "iam_user_console_access_unused", "secretsmanager_automatic_rotation_enabled"},
}
var GxP_21_11_300_d = &NistComp{
	Framework:     "GxP-21-CFR-Part-11",
	Provider:      "AWS",
	Frameworkdesc: "GxP refers to the regulations and guidelines that are applicable to life sciences organizations that make food and medical products. Medical products that fall under this include medicines, medical devices, and medical software applications. The overall intent of GxP requirements is to ensure that food and medical products are safe for consumers. It's also to ensure the integrity of data that's used to make product-related safety decisions.",
	Id:            "11.300-d",
	...
	Section:       "11.300 Controls for identification codes/passwords",
	Checks:        []string{"cloudtrail_multi_region_enabled", "cloudtrail_cloudwatch_logging_enabled", "guardduty_is_enabled", "securityhub_enabled"},
}
