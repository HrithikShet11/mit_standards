...
type MitreComp struct {
	...
	TechniqueURL  string      `json:"TechniqueURL"`
...
var Mitre_T1190 = &MitreComp{
	...
	Checks:        []string{"drs_job_exist", "config_recorder_all_regions_enabled", "rds_instance_minor_version_upgrade_enabled", "rds_instance_backup_enabled", "securityhub_enabled", "elbv2_waf_acl_attached", "guardduty_is_enabled", "inspector2_is_enabled", "inspector2_active_findings_exist", "awslambda_function_not_publicly_accessible", "ec2_instance_public_ip"},
...
var Mitre_T1199 = &MitreComp{
	...
	Tactics:       []string{"Initial Access"},
	SubTechniques: []string{},
	Platforms:     []string{"Office 365", "IaaS", "Linux", "SaaS", "Windows", "macOS"},
...
var Mitre_T1078 = &MitreComp{
	...
	SubTechniques: []string{"T1078.001 - Default Accounts", "T1078.004 - Cloud Accounts"},
...
var Mitre_T1059 = &MitreComp{
	...
	SubTechniques: []string{"T1059.009 - Cloud API"},
	Platforms:     []string{"Azure AD", "IaaS", "Google Workspace", "Linux", "Network", "Office 365", "Windows", "macOS"},
...
var Mitre_T1648 = &MitreComp{
	...
	Checks:        []string{"iam_aws_attached_policy_no_administrative_privileges", "iam_customer_attached_policy_no_administrative_privileges", "iam_inline_policy_no_administrative_privileges", "iam_policy_allows_privilege_escalation", "iam_policy_no_full_access_to_cloudtrail", "iam_policy_no_full_access_to_kms"},
	Attributes: []Attribute{
		{
			AWSService: "AWS IAM",
			Category:   "Protect",
...
var Mitre_T1204 = &MitreComp{
	...
	Name:          "User Execution",
	Tactics:       []string{"Execution"},
	SubTechniques: []string{"T1204.003 - Malicious Image"},
	Platforms:     []string{"IaaS", "Containers", "Linux", "Windows", "macOS"},
...
var Mitre_T1098 = &MitreComp{
	...
	SubTechniques: []string{"T1098.001 - Additional Cloud Credentials", "T1098.003 - Additional Cloud Roles", "T1098.004 - SSH Authorized Keys"},
	Platforms:     []string{"IaaS", "Office 365", "SaaS"},
...
var Mitre_T1136 = &MitreComp{
	...
	Name:          "Create Account",
	Tactics:       []string{"Persistence"},
	SubTechniques: []string{"T1136.003 - Cloud Account"},
	Platforms:     []string{"Azure AD", "Google Workspace", "IaaS", "Linux", "Network", "Office 365", "Windows", "macOS"},
...
var Mitre_T1546 = &MitreComp{
	...
	Tactics:       []string{"Privilege Escalation", "Persistence"},
	SubTechniques: []string{},
	Platforms:     []string{"Google Workspace", "IaaS", "Linux", "Office 365", "Windows", "macOS"},
...
var Mitre_T1525 = &MitreComp{
	...
	Tactics:       []string{"Persistence"},
	SubTechniques: []string{},
	Platforms:     []string{"IaaS", "Containers"},
...
var Mitre_T1556 = &MitreComp{
	...
	Tactics:       []string{"Credential Access", "Defense Evasion", "Persistence"},
	SubTechniques: []string{"T1556.006 - Multi-Factor Authentication", "T1556.007 - Hybrid Identity"},
	Platforms:     []string{"Azure AD", "Google Workspace", "IaaS", "Linux", "Network", "Office 365", "Windows", "macOS"},
	...
	Checks:        []string{"iam_root_mfa_enabled", "iam_user_mfa_enabled_console_access", "iam_user_hardware_mfa_enabled", "iam_root_hardware_mfa_enabled"},
	Attributes: []Attribute{
		{
			AWSService: "AWS IAM",
			Category:   "Protect",
...
var Mitre_T1562 = &MitreComp{
	...
	SubTechniques: []string{"T1562.006 - Disable or Modify Tools", "T1562.007 - Disable or Modify Cloud Firewall", "T1562.008 - Disable Cloud Logs"},
	...
	Checks:        []string{"config_recorder_all_regions_enabled", "securityhub_enabled", "guardduty_is_enabled", "inspector2_is_enabled", "inspector2_active_findings_exist"},
	Attributes: []Attribute{
		{
			AWSService: "AWS Config",
			Category:   "Detect",
...
var Mitre_T1578 = &MitreComp{
	...
	Tactics:       []string{"Defense Evasion"},
	SubTechniques: []string{"T1578.001 - Create Snapshot", "T1578.002 - Create Cloud Instance", "T1578.003 - Delete Cloud Instance", "T1578.004 - Revert Cloud Instance"},
...
var Mitre_T1550 = &MitreComp{
	...
	SubTechniques: []string{"T1550.001 - Application Access Token", "T1550.004 - Web Session Cookie"},
	Platforms:     []string{"IaaS"},
...
var Mitre_T1110 = &MitreComp{
	...
	SubTechniques: []string{"T1110.001 - Password Guessing", "T1110.003 - Password Spraying", "T1110.004 - Credential Stuffing"},
	Platforms:     []string{"Azure AD", "Containers", "Google Workspace", "IaaS", "Linux", "Network", "Office 365", "SaaS", "Windows", "macOS"},
	...
	Checks:        []string{"guardduty_is_enabled", "config_recorder_all_regions_enabled", "iam_user_accesskey_unused", "iam_user_console_access_unused", "iam_password_policy_expires_passwords_within_90_days_or_less", "iam_password_policy_lowercase", "iam_password_policy_minimum_length_14", "iam_password_policy_number", "iam_password_policy_reuse_24", "iam_password_policy_symbol", "iam_password_policy_uppercase", "iam_root_hardware_mfa_enabled", "iam_root_mfa_enabled", "iam_rotate_access_key_90_days", "iam_user_hardware_mfa_enabled", "iam_user_mfa_enabled_console_access", "securityhub_enabled", "inspector2_is_enabled", "inspector2_active_findings_exist"},
	Attributes: []Attribute{
		{
			AWSService: "AWS Config",
			Category:   "Protect",
...
var Mitre_T1606 = &MitreComp{
	...
	Tactics:       []string{"Credential Access"},
	SubTechniques: []string{"T1606.001 - Web Cookies", "T1606.002 - SAML Tokens"},
	...
	Checks:        []string{"iam_no_custom_policy_permissive_role_assumption", "iam_policy_allows_privilege_escalation"},
	Attributes: []Attribute{
		{
			AWSService: "AWS IAM",
			Category:   "Protect",
...
var Mitre_T1048 = &MitreComp{
	...
	SubTechniques: []string{},
	Platforms:     []string{"Google Workspace", "IaaS", "Linux", "Network", "Office 365", "SaaS", "Windows", "macOS"},
	Description:   "Adversaries may steal data by exfiltrating it over a different protocol than that of the existing command and control channel. The data may also be sent to an alternate network location from the main command and control server.",
	TechniqueURL:  "https://attack.mitre.org/techniques/T1048/",
	Checks:        []string{"networkfirewall_in_all_vpc", "guardduty_is_enabled", "ec2_networkacl_allow_ingress_any_port", "ec2_networkacl_allow_ingress_tcp_port_22", "ec2_networkacl_allow_ingress_tcp_port_3389", "ec2_securitygroup_allow_ingress_from_internet_to_any_port", "ec2_securitygroup_allow_ingress_from_internet_to_port_mongodb_27017_27018", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_ftp_port_20_21", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_22", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_3389", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_cassandra_7199_9160_8888", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_elasticsearch_kibana_9200_9300_5601", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_kafka_9092", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_memcached_11211", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_mysql_3306", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_oracle_1521_2483", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_postgres_5432", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_redis_6379", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_sql_server_1433_1434", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_telnet_23"},
	Attributes: []Attribute{
		{
...
var Mitre_T1119 = &MitreComp{
	...
	Checks:        []string{"config_recorder_all_regions_enabled", "ec2_ebs_default_encryption", "ec2_ebs_snapshots_encrypted", "ec2_ebs_volume_encryption", "s3_bucket_default_encryption", "rds_instance_storage_encrypted"},
	Attributes: []Attribute{
		{
			AWSService: "AWS Config",
			Category:   "Protect",
...
var Mitre_T1074 = &MitreComp{
	...
	Name:          "Data from Cloud Storage",
	Tactics:       []string{"Collection"},
	SubTechniques: []string{"T1074.002 - Remote Data Staging"},
...
var Mitre_T1485 = &MitreComp{
	...
	Checks:        []string{"drs_job_exist", "rds_instance_deletion_protection", "rds_instance_backup_enabled", "efs_have_backup_enabled", "backup_plans_exist", "s3_bucket_object_lock", "s3_bucket_no_mfa_delete", "cloudwatch_log_metric_filter_disable_or_scheduled_deletion_of_kms_cmk", "s3_bucket_policy_public_write_access", "dynamodb_tables_pitr_enabled", "s3_bucket_object_versioning", "config_recorder_all_regions_enabled"},
	Attributes: []Attribute{
		{
			AWSService: "AWS CloudEndure Disaster Recovery",
			Category:   "Respond",
...
var Mitre_T1486 = &MitreComp{
	...
	Checks:        []string{"drs_job_exist", "s3_bucket_object_lock", "s3_bucket_policy_public_write_access", "dynamodb_tables_pitr_enabled", "backup_plans_exist", "s3_bucket_object_versioning", "rds_instance_backup_enabled", "efs_have_backup_enabled", "config_recorder_all_regions_enabled"},
	Attributes: []Attribute{
		{
			AWSService: "AWS CloudEndure Disaster Recovery",
			Category:   "Respond",
...
var Mitre_T1491 = &MitreComp{
	...
	Name:          "Defacement",
	Tactics:       []string{"Impact"},
	SubTechniques: []string{"T1491.002 - External Defacement"},
	Platforms:     []string{"IaaS", "Linux", "Windows", "macOS"},
	...
	Checks:        []string{"drs_job_exist", "config_recorder_all_regions_enabled"},
	Attributes: []Attribute{
		{
			AWSService: "AWS CloudEndure Disaster Recovery",
			Category:   "Respond",
...
var Mitre_T1499 = &MitreComp{
	...
	Tactics:       []string{"Impact"},
	SubTechniques: []string{"T1499.002 - Service Exhaustion Flood", "T1499.003 - Application Exhaustion Flood", "T1499.004 - Application or System Exploitation"},
	...
	Checks:        []string{"networkfirewall_in_all_vpc", "config_recorder_all_regions_enabled", "shield_advanced_protection_in_associated_elastic_ips", "shield_advanced_protection_in_classic_load_balancers", "shield_advanced_protection_in_cloudfront_distributions", "shield_advanced_protection_in_global_accelerators", "shield_advanced_protection_in_internet_facing_load_balancers", "shield_advanced_protection_in_route53_hosted_zones", "ec2_networkacl_allow_ingress_any_port", "ec2_networkacl_allow_ingress_tcp_port_22", "ec2_networkacl_allow_ingress_tcp_port_3389", "ec2_securitygroup_allow_ingress_from_internet_to_any_port", "ec2_securitygroup_allow_ingress_from_internet_to_port_mongodb_27017_27018", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_ftp_port_20_21", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_22", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_3389", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_cassandra_7199_9160_8888", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_elasticsearch_kibana_9200_9300_5601", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_kafka_9092", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_memcached_11211", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_mysql_3306", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_oracle_1521_2483", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_postgres_5432", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_redis_6379", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_sql_server_1433_1434", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_telnet_23"},
	Attributes: []Attribute{
		{
...
var Mitre_T1490 = &MitreComp{
	...
	Checks:        []string{"drs_job_exist", "rds_instance_backup_enabled"},
	Attributes: []Attribute{
		{
			AWSService: "AWS CloudEndure Disaster Recovery",
			Category:   "Respond",
...
var Mitre_T1496 = &MitreComp{
	...
	Tactics:       []string{"Impact"},
	SubTechniques: []string{},
	Platforms:     []string{"IaaS", "Linux", "Containers", "Windows", "macOS"},
...
var Mitre_T1087 = &MitreComp{
	...
	SubTechniques: []string{"T1087.004 - Cloud Account"},
	Platforms:     []string{"Azure AD", "Google Workspace", "IaaS", "Linux", "Office 365", "SaaS", "Network", "Windows", "macOS"},
...
var Mitre_T1538 = &MitreComp{
	...
	Checks:        []string{"organizations_account_part_of_organizations", "iam_user_mfa_enabled_console_access", "iam_customer_attached_policy_no_administrative_privileges", "iam_aws_attached_policy_no_administrative_privileges", "iam_inline_policy_no_administrative_privileges"},
	Attributes: []Attribute{
		{
			AWSService: "AWS Organizations",
			Category:   "Protect",
...
var Mitre_T1619 = &MitreComp{
	...
	Checks:        []string{"iam_customer_attached_policy_no_administrative_privileges", "iam_aws_attached_policy_no_administrative_privileges", "iam_inline_policy_no_administrative_privileges", "iam_policy_allows_privilege_escalation"},
	Attributes: []Attribute{
		{
			AWSService: "AWS IAM",
			Category:   "Protect",
...
var Mitre_T1046 = &MitreComp{
	...
	Checks:        []string{"networkfirewall_in_all_vpc", "elbv2_waf_acl_attached", "guardduty_is_enabled", "inspector2_is_enabled", "inspector2_active_findings_exist", "ec2_networkacl_allow_ingress_any_port", "ec2_networkacl_allow_ingress_tcp_port_22", "ec2_networkacl_allow_ingress_tcp_port_3389", "ec2_securitygroup_allow_ingress_from_internet_to_any_port", "ec2_securitygroup_allow_ingress_from_internet_to_port_mongodb_27017_27018", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_ftp_port_20_21", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_22", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_3389", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_cassandra_7199_9160_8888", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_elasticsearch_kibana_9200_9300_5601", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_kafka_9092", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_memcached_11211", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_mysql_3306", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_oracle_1521_2483", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_postgres_5432", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_redis_6379", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_sql_server_1433_1434", "ec2_securitygroup_allow_ingress_from_internet_to_tcp_port_telnet_23"},
	Attributes: []Attribute{
		{
			AWSService: "AWS IoT Device Defender",
			Category:   "Detect",
...
var Mitre_T1518 = &MitreComp{
	...
	Tactics:       []string{"Discovery"},
	SubTechniques: []string{"T1518.001 - Security Software Discovery"},
	Platforms:     []string{"Azure AD", "Google Workspace", "IaaS", "Linux", "Office 365", "SaaS", "Windows", "macOS"},
...
var Mitre_T1069 = &MitreComp{
	...
	Tactics:       []string{"Discovery"},
	SubTechniques: []string{"T1069.003 - Cloud Groups"},
	Platforms:     []string{"Azure AD", "Containers", "Google Workspace", "IaaS", "Linux", "Office 365", "SaaS", "Windows", "macOS"},
